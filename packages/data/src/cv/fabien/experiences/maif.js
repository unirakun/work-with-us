export default {
  ...
  informations: [
    ...
    `Le POC a comme ambition de montrer à ces agents qu’il est possible de travailler dans un environnement plus souple,
    réactif et moderne. Ce projet se concentre uniquement sur la partie « Déclaration de Sinistre »
    et présente différentes vues simple à appréhender et à utiliser.`,
    `> Mise en place d’une architecture frontend réactive et évolutive basée sur l’architecture composant proposée
    par ReactJS (produit Facebook) et de Redux, l’approche unidirectionnelle de traitement des données
