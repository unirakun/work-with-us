export default {
  ...
  informations: [
    ...
    'Une des contrainte était de pouvoir faire cette migration par itération, les deux versions de l\'application devaient donc co-exister. Nous avons donc fait le choix de conserver l\'aspect graphique, et de faire des ponts AngularJS vers React, et inversement',
    'Missions :',
    [
      ...
      'Formation continue de l\'équipe de développement Sparklane sur cette nouvelle stack.',
